...
if (($null -eq $openblaslib) -or ($null -eq $cblash) -or ($null -eq $lapackeh)) {
  ...
  if (-not ($hash -eq "74BB55BCC4C5B760A08424ED7A53D08FF9581278BB05441F7F6E5F43AADCF8CA")) { Write-Error "opemblas hash does not match" }
  ...
  if (-not ($hash -eq "BC50A67898F82820F5138938FBAABC90CF13495CE188E91725A33B6FAD25F06F")) { Write-Error "libflang hash does not match" }
