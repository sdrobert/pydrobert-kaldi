...
def test_callback_delivers_correct_messages(kaldi_logger, registered_regular_logger):
...
def test_python_error_doesnt_segfault(registered_regular_logger, temp_file_1_name):
